...
Обычно я пользуюсь оболочкой GNOME и после установки ОС удаляю ненужные, предустановленные пакеты. Если пользуетесь другой оболочкой вам не нужна эта страница.
